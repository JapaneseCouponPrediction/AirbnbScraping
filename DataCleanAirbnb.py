...
# iterate in different fold and clean data
def IterateCleanData(rootdir):
...
def DataClean():
    ...
    data['MemberLength'] = dt.datetime.strptime('2015-09-13', '%Y-%m-%d') - data.MemberDateNew.apply(lambda x: dt.datetime.strptime(x, '%Y-%m-%d'))
    ...
    data.to_csv(current_filepath+'clean.csv')
...
if __name__ == '__main__':
    rootdir = "/Users/hongyingyang/Documents/airbnb/airbnb_data"
    IterateCleanData(rootdir)